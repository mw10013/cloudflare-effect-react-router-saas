      ...
      return renderListItem(
        {
          ...
          className: buttonStyles({
            ...
            size,
            className: twMerge(
              "cursor-default font-normal tabular-nums disabled:cursor-default disabled:opacity-100 focus-visible:border-primary focus-visible:bg-primary/10 focus-visible:ring-4 focus-visible:ring-ring/20",
              className,
            ),
          }),
          ...props,
